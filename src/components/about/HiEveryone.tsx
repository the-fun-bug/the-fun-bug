    ...
    <section className="flex justify-center items-center pt-[1rem] pb-[3rem] px-[1rem]">
      <div className="flex flex-col justify-center items-center w-full max-w-[1200px]">
        ...
        <div className="py-[2rem] flex flex-col gap-[1.25rem] text-center">
          ...
          <p>
            We are the Saurs. I am Kameron and my husband is Clay, or as my
            sweet in-laws like to call it, the ‘vision’ and the ‘labor’. We have
            two amazing kiddos, Olivia and Levi. We are big on nicknames around
            here! Our daughter Olivia is our Bug! And our son Levi is our Worm!
            Thus, The Fun Bug was born.
          </p>
          ...
          <p>
            ...
            lounging, free Wi-Fi, and plenty of workspace. Oh, and did I mention

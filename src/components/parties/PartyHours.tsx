...
export default function PartyHours() {
  ...
  return (
    <section className="flex justify-center items-center py-[3rem] md:px-[1rem]">
      <div className="flex justify-center md:justify-between items-center text-center gap-[1rem] w-full max-w-[1000px]">
        <div className="w-full md:w-[50%] flex flex-col gap-[1rem]">
          ...
          <div className="flex flex-col gap-[1rem]">
            ...
            <div className="w-full flex justify-evenly items-center md:justify-center gap-[1rem]">
